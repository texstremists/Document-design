...
% - If you use page dimensions other than A4, you will have to adjust absolute distances (e.g. vertical spacing, margins). Note that the drawings are coded relatively to page dimensions, so they should not be affected.
%
% # LEGACY version
%
...
% Define abstract environment, in a way agnostic of language
